...
class RequestAccountInfo extends StatelessWidget {
  ...
  Widget buildAccountReceiptInfo() => Container(
        ...
        child: Text(
          "End-to-end encryption ensures only you and the person you're communicating with can read or listen to what is sent, and nobody in between, not even Quee. This is because with end-to-end encryption, your messages are secured with a lock.",
